package com.pettyfox.platform_example.web.listener;

import com.pettyfox.platform_example.web.config.MybatisConfiguration;
...
public class ApplicationContextStartedListener implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public void onApplicationEvent(ApplicationReadyEvent event) {
        ...
        MybatisConfiguration.initMybatisTypeHandler(event);
